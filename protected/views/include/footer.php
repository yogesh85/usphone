<div class="footer">
	<div class="ftrancd">
		<a href="<?php echo Yii::t("custom", "site.url"); ?>"><span class="footer_anc">Home</span></a>
		<a href="<?php echo (new Clicky)->areaCodeDirectoryUrl() ?>"><span class="footer_anc">Area Codes</span></a>
		<a href="<?php echo Yii::t("custom", "site.url")."/privacy-policy"; ?>"><span class="footer_anc">Privacy Policy</span></a>
	</div>
